...
| Platform | File | Notes |
|---|---|---|
| **Debian / Ubuntu** | [`gitbraid_0.5.3_amd64.deb`](https://github.com/heri-anggara/gitbraid/releases/download/v0.5.3/gitbraid_0.5.3_amd64.deb) | Installs into the applications menu |
| **Any Linux** | [`GitBraid-0.5.3.AppImage`](https://github.com/heri-anggara/gitbraid/releases/download/v0.5.3/GitBraid-0.5.3.AppImage) | One file, no install, updates itself |
| **Windows** | [`GitBraid Setup 0.5.3.exe`](https://github.com/heri-anggara/gitbraid/releases/download/v0.5.3/GitBraid.Setup.0.5.3.exe) | Unsigned — see the note below |
...
```bash
sudo apt install ./gitbraid_0.5.3_amd64.deb
```
...
```bash
chmod +x GitBraid-0.5.3.AppImage
./GitBraid-0.5.3.AppImage
```
...
npm install
npm start                 # run it
npm test                  # 178 checks, no network, no fixtures to download
